...
const Lottery = () => {
  ...
  console.log("lottery", lotteryCard);
                      ...
                      >
                        {lotteryCard ? (
                          <>
                            ...
                            <Box
                              color={
                                colorMode === "dark" ? "gray.100" : textColor
                              }
                              id="BNB Field"
                              p="3"
                              // height="100px"
                            ...
                            >
                              ...
                              <Flex flexDir="column">
                                ...
                                <Flex>
                                  <Box p="4">Cost (BABY)</Box>
                                  <Spacer />
                                  <Box p="4">0 BABY</Box>
                                </Flex>
                                <Flex>
                                  <Box p="4" style={{ display: "flex" }}>
                                    <Text fontWeight={`bold`}> 0% </Text>-Bulk
                                    discount
                                  </Box>
                                  <Spacer />
                                  <Box p="4">~0 BABY</Box>
                            ...
                            {account ? (
                              <Center my="10">
                                <Button
                                  ...
                                  //   setLotteryCard(true);
                                  // }}
                                  onClick={() => setlotteryBuyEnable(true)}
                                  // onClick={() => {
                                  //   onOpen;
                                  // }}
                                >
                      ...
                      >
                        <>
                          ...
                          >
                            ...
                            >
                              <GridItem colSpan={1}>
                                <Text fontSize="2xl">Prize Pot</Text>
                              </GridItem>
                              <GridItem colSpan={4}>
                                {" "}
                                ...
                                <Text>20,795 BABY</Text>
                              </GridItem>
                              <GridItem colSpan={1}>
                                <Text fontSize="2xl">Prize Pot</Text>
                              </GridItem>
                              <GridItem colSpan={2}>
                                <Text>You have 0 ticket this round</Text>
                              </GridItem>
                              <GridItem colSpan={2}>
                                <Button
                                  // focusBorderColor="none"
                            ...
                            <Box>
                              <Collapse in={show}>
                                <Text>
                                  ...
                                  share prize. Current prizes up for grabs:
                                </Text>
                                <Grid
                                  mt={8}
                                  // h='200px'
                      ...
                      >
                        ...
                        <Flex my={5} justifyContent={"center"}>
                          <Center fontSize="sm" mt="-10px">
                            ...
                            each round starts, equal to $5 at that time.
                            Purchases are final.
                          </Center>
                        </Flex>
                        <Center my="10">
